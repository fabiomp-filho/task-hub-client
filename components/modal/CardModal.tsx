...
const Modal: React.FC<ModalProps> = ({
    ...
    const handleTitleBlur = () => {
        ...
        CardService.updateTitle(request, cardId)
            .catch(() => {})
            .finally(() => {
                fetchBoard();
            })
    ...
    return (
        <div
            className={`fixed  inset-0 z-50  py-16 flex items-center justify-center bg-black bg-opacity-50 
            ...
            <div
                ...
                <div className="flex justify-between items-center pt-4 ps-6 pb-2 pr-8">
